...
public class AtividadeController {
    ...
    public void confimarCriacao(String titulo, java.util.Date data_inicio, int horario_inicio, java.util.Date data_termino, int horario_termino, int max_participantes, br.unesp.fct.seccomp.domain.Participante ministrantes, int carga_horaria_ministrantes) {}
}
